...
/**
 * Processing expand and collapse event parameters
 * @param collapsed Expand and collapse event parameters
 */
...
// Dependency injection of all configuration items, control of properties, and reduction of value transfer
