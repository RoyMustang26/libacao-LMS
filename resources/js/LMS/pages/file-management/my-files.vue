...
const files = ref([
  {
    id: 1,
    dateUpload: '2025-09-12 15:38:41',
    title: 'IAS 301 Prelims Reviewer',
    filename: 'IAS 301 Prelims Reviewer.pdf',
    type: 'FILE',
    isShared: 'No',
  },
  {
    id: 2,
    dateUpload: '2025-09-05 18:04:16',
    title: 'Generations of IT',
    filename: 'ReviewerITE101LivingIntheITEra.pdf',
    type: 'FILE',
    isShared: 'No',
  },
])
...
const columns = [
  { title: 'Date Upload', dataIndex: 'dateUpload', key: 'dateUpload' },
  { title: 'Title', dataIndex: 'title', key: 'title' },
  { title: 'Filename', dataIndex: 'filename', key: 'filename' },
  { title: 'Type', dataIndex: 'type', key: 'type' },
  { title: 'Is Shared?', dataIndex: 'isShared', key: 'isShared' },
...
<template>
  <div>
    ...
    <!-- Files Table -->
    <a-table
      row-key="id" :columns="columns" :data-source="files"
