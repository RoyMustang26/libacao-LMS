  ...
  <div class="loading-wrapper">
    <a-card title="Command mode loading" :hoverable="true" :bordered="false">
      <div
        ...
        loading-text="Custom command loading"
        loading-spin="pulse"
        :loading-full="full"
      >
        <a-space :size="15">
          <a-button type="primary" @click="startCustomLoading(1)">
            v-loading directive full screen
          </a-button>
          <a-button type="primary" @click="startCustomLoading(2)">
            v-loading directive non-full screen
          </a-button>
        </a-space>
      </div>
    </a-card>
    <a-card title="hook loading loading" hoverable :bordered="false" style="margin-top:15px">
      <a-space :size="15">
    ...
    <a-card title="Minimum hooloading duration" hoverable :bordered="false">
      <a-space :size="15">
